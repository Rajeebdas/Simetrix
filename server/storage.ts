...
export class MemStorage implements IStorage {
  ...
  private initializeSampleData() {
    ...
    const testimonial1: Testimonial = {
      ...
      content: "Simetric's FEA analysis saved us months of physical prototyping. Their optimization reduced our component weight by 30% while maintaining all safety requirements.",
      rating: 5,
      featured: true,
      createdAt: new Date(),
    };
    ...
    const caseStudy3: CaseStudy = {
      ...
      timeline: "4 Weeks",
      imageUrl: "https://images.unsplash.com/photo-1593941707882-a5bac6861d75?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=300",
      featured: true,
      createdAt: new Date(),
    };
    ...
    const blogPost1: BlogPost = {
      ...
      author: "Simetric Engineering Team",
