  ...
  const industries = [
    {
      ...
      description:
        "Heavy equipment, manufacturing systems, and industrial automation components",
      image:
        "https://images.unsplash.com/photo-1565814329452-e1efa11c5b89?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300",
    },
    {
      title: "Commercial Vehicles",
      description:
        "Truck chassis, commercial vehicle frames, and heavy-duty transportation systems",
      image:
    ...
    },
    {
      ...
      description:
        "Battery housings, EV chassis, and electric vehicle component design",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 fade-in">
          ...
          <p className="text-xl text-secondary max-w-3xl mx-auto stagger-1">
            ...
            industrial sectors with precision and expertise
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {industries.map((industry, index) => (
            <div
              key={index}
              className={`text-center group fade-in stagger-${(index % 4) + 1} transform hover:translateY(-4px) transition-all duration-300`}
            >
              <img
                src={industry.image}
                alt={industry.title}
