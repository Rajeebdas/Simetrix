        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="slide-in-left">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
              Engineering <span className="text-sky-200">Insight</span> Through
              Simulation
            </h1>
            <p className="text-xl mb-8 text-blue-100 leading-relaxed stagger-1">
              Empowering global clients to create safer, lighter, and more
              cost-effective products through advanced FEA, CAD modeling, and
